...
public class BaseUi {
	...
	protected String executeJavascriptStringReturn(String script) {
		((JavascriptExecutor) driver).executeScript(script);
		return script;
	}
	...
	public void highlight(WebElement element) {
		((JavascriptExecutor) driver).executeScript("arguments[0].style.backgroundColor = 'rgb(255, 255, 0)'", element);
	}
